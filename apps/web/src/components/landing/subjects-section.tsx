  ...
  return (
    <section className="bg-secondary/50 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        {/* Subject cards grid */}
        <div className="mx-auto grid max-w-4xl grid-cols-3 gap-4 lg:grid-cols-9 lg:max-w-none">
          {SUBJECTS.map((subject) => {
            ...
            return (
              ...
              >
                <div
                  className={cn(
                    "flex flex-col items-center gap-3 rounded-xl border border-border bg-card p-4 transition-all duration-200 hover:-translate-y-1 hover:shadow-md sm:p-5",
                    config.border
                  )}
                >
                  ...
                  <div
                    className={cn(
                      "flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br transition-all duration-200",
                      config.gradient
                    )}
                  >
                    <IconComponent
                      className={cn("h-5 w-5", SUBJECT_ICON_COLORS[subject])}
                    />
                  </div>
